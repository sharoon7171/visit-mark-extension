export const colorFieldRoot =
  "flex w-full min-w-0 flex-col divide-y divide-border px-4 font-sans";

export const colorFieldTopRow =
  "flex items-center justify-between gap-3 py-2.5 sm:gap-4";
...
export const colorPickerEmbed =
  "w-full max-w-full overflow-hidden rounded-lg border border-border bg-surface-muted px-1 py-2 shadow-well [&>.react-colorful]:h-28! [&>.react-colorful]:w-full! [&>.react-colorful]:max-w-full!";

export const colorPickerRoot = "w-full";
